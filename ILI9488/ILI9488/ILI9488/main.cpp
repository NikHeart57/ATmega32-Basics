...
// todo 
// нажатие на экран и выбор шарика
// взаимодействие с шариком, удар шариком по шарикам
// удаление шариков (попадание в лунку)
// Оптимизация, в плане остановки отрисовки тех шаров которые не движутся
